...
import { DiscordLink } from "../components/DiscordLink.tsx";
...
export default function ProductDetails({ product }: { product: Product }) {
  ...
  return (
    <div class="w-11/12 max-w-5xl mx-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-x-16">
      ...
      <div>
        <div class="flex flex-col gap-4">
          <div class="w-full flex items-center justify-between gap-4">
            <hgroup>
              <h2 class="text-xl lg:!text-2xl font-semibold text-green-500">
                {product.title}
              </h2>
      ...
      {/* Product image */}
      <div
        class={` w-full bg-white rounded-xl border-2 border-gray-200 mt-12 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-start`}
      >
